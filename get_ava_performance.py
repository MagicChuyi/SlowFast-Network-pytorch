...
def read_labelmap(labelmap_file):
  ...
  """
  print('labelmap_file',labelmap_file)
  labelmap = []
  class_ids = set()
  name = ""
  class_id = ""
...
def parse_arguments():
  ...
  parser.add_argument(
      ...
      default='/home/aiuser/ava_v2.2/ava_v2.2/'+EvalConfig.PATH_TO_ACTION_LIST)
  parser.add_argument(
      "-g",
      "--groundtruth",
      help="CSV file containing ground truth.",
      type=argparse.FileType("r"),
      default='/home/aiuser/ava/ava/preproc_train/'+EvalConfig.PATH_TO_LABLE,
      #default='/home/aiuser/ava_v2.2/preproc/'+'train_clips/' + EvalConfig.PATH_TO_LABLE,
      required=False)
  ...
  parser.add_argument(
      ...
      type=argparse.FileType("r"),
      default='/home/aiuser/ava/ava/'+EvalConfig.PATH_TO_RESULTS,
      required=False)
  parser.add_argument(
      "-e",
      "--exclusions",
