...
class VOC2007(Base):
    ...
    def __init__(self, path_to_data_dir: str, mode: Base.Mode, image_min_side: float, image_max_side: float):
        ...
        for image_id in self._image_ids:
            #path_to_annotation_xml = os.path.join(path_to_annotations_dir, 'image_id.xml')
            path_to_annotation_xml=path_to_annotations_dir+'/'+image_id+'.xml'
            print('image_id',image_id,path_to_annotation_xml)
